...
<html lang="en">
    ...
    <body class="h-full w-full">
        <header class="fixed top-0 px-[40px] min-w-full h-[60px] bg-[#A08963] grid grid-cols-[1fr_2fr] z-9">
            ...
            <div class="pr-[20px] flex justify-end gap-x-[10px] text-white">
                <button
                class="mt-[8px] lexend-regular h-[50px] min-w-[128px] cursor-pointer focus:outline-none"
                id="home-button"
                >
                    Edit Home
                ...
                <button
                class="mt-[8px] lexend-regular h-[50px] min-w-max max-w-[128px] cursor-pointer focus:outline-none"
                id="customers-button"
                >
                    Customer
                    <hr class="mt-[8px] border-y-[2px] border-[#D9D9D9] rounded-xl m-auto" style="visibility: hidden;">
                </button>
                <form action="/logout" method="POST" class="ml-[10px] h-[60px] flex items-center" onsubmit="return confirm('Apakah anda yakin?')">
                    @csrf
                    <button
                    type="submit"
                    class="lexend-regular h-[32px] w-[128px] text-[#A08963] rounded-full bg-white outline outline-[#706D54] cursor-pointer hover:bg-gray-100 active:bg-gray-200 focus:outline-none"
                    id="logout"
                    >
                        Logout
                    </button>
            ...
            >
                ...
                >
                    ...
                    <div class="justify-self-center flex gap-x-[60px] mt-[120px] fade-in-section opacity-0 translate-y-8 transition-all duration-700 ease-out">
                        <div class="w-[320px] h-[300px] rounded-[24px] flex justify-center cursor-pointer hover:outline-2 hover:outline-[#706D54] hover:bg-gray-100 active:bg-gray-200" style="box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.25);"
                        >
                            <img src="{{ asset('assets/images/logo2.svg') }}" alt="logo" class="min-h-full max-h-full">
                        </div>
                        <div class="flex flex-col items-end w-[520px]">
                            <h1 class="mt-1 lemon-regular text-[#706D54] text-end text-[40px]">
                                Bin Auf Coffee
                            </h1>
                            <div class="cursor-pointer hover:outline-2 hover:outline-[#706D54] hover:bg-gray-100 active:bg-gray-200 mt-5">
                                <p class="lexend-regular text-[#706D54] text-end text-xl">
                ...
                >
                    <div class="w-full grid grid-cols-2 fade-in-section opacity-0 translate-y-8 transition-all duration-700 ease-out">
                        <div class="ml-[160px] mt-[20px] mr-[120px]">
                            ...
                            <div class="cursor-pointer hover:outline-2 hover:outline-[#706D54] hover:bg-gray-100 active:bg-gray-200">
            ...
            >
                <div class="min-h-max w-full">
                    ...
                    <div class="fade-in-section opacity-0 translate-y-8 transition-all duration-700 ease-out grid justify-items-center pt-[140px] pb-[100px]" id="opening">
                        ...
                        <div class="h-[calc(100%-40px)] cursor-pointer hover:outline-2 hover:outline-[#706D54] hover:bg-gray-100 active:bg-gray-200">
                    ...
                    <div id="show-news" style="display: none;">
                        <div class="fade-in-section opacity-0 translate-y-8 transition-all duration-700 ease-out grid justify-items-center pt-[140px] pb-[60px]">
                            ...
                            <div class="cursor-pointer hover:outline-2 hover:outline-[#706D54] hover:bg-gray-100 active:bg-gray-200 mt-[10px] mb-[20px]">
                                <h1 class="lexend-bold text-[#A08963] text-[42px]" id="title"></h1>
                            </div>
                            ...
                            <div class="cursor-pointer hover:outline-2 hover:outline-[#706D54] hover:bg-gray-100 active:bg-gray-200 mx-[140px]">
                                <div class="flex flex-col gap-[20px] lexend-medium text-[#706D54] text-xl text-justify" id="content">
                                    <p>
            ...
            >
                <div
                class="min-w-full min-h-screen mb-[80px]"
                >
                    <div>
                        <img src="{{ asset('assets/images/ellipse_coklat.svg') }}" alt="ellipse" class="absolute top-0 min-w-full h-[240px] -z-10">
                        <img src="{{ asset('assets/images/ellipse_putih.svg') }}" alt="ellipse" class="absolute top-0 min-w-full h-[160px] -z-10">
                    </div>
                    <div class="mt-[120px] fade-in-section opacity-0 translate-y-8 transition-all duration-700 ease-out min-w-full">
                        <h1 class="lexend-bold text-[#A08963] text-4xl mb-[40px] text-center">
                            ORDER LIST
                        </h1>
                        <div class="grid grid-cols-1 gap-[28px] justify-self-center min-w-full px-[120px]" id="order-list"></div>
                    </div>
                </div>
            </div>
        </main>
